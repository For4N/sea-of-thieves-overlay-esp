...
int DrawString(char* String, int x, int y, int r, int g, int b, ID3DXFont* ifont)
{
	...
	FontPos.left = x;
	FontPos.top = y;
	ifont->DrawTextA(0, String, (int)strlen(String), &ShadowPos, DT_NOCLIP, D3DCOLOR_ARGB(255, r / 3, g / 3, b / 3));
	ifont->DrawTextA(0, String, (int)strlen(String), &FontPos, DT_NOCLIP, D3DCOLOR_ARGB(255, r, g, b));
	return 0;
}
...
int DrawCenterString(char* String, int x, int y, int r, int g, int b, ID3DXFont* ifont)
{
	...
	FontPos.left = x;
	FontPos.top = y;
	ifont->DrawTextA(0, String, (int)strlen(String), &ShadowPos, DT_CENTER, D3DCOLOR_ARGB(255, r / 3, g / 3, b / 3));
	ifont->DrawTextA(0, String, (int)strlen(String), &FontPos, DT_CENTER, D3DCOLOR_ARGB(255, r, g, b));
	return 0;
}
...
int DrawShadowString(char* String, int x, int y, int r, int g, int b, ID3DXFont* ifont)
{
	...
	Fonts3.left = x;
	Fonts3.top = y-1;
	ifont->DrawTextA(0, String, (int)strlen(String), &Fonts3, DT_NOCLIP , D3DCOLOR_ARGB(255, 1, 1, 1));
	ifont->DrawTextA(0, String, (int)strlen(String), &Fonts2, DT_NOCLIP, D3DCOLOR_ARGB(255, 1, 1, 1));
	ifont->DrawTextA(0, String, (int)strlen(String), &Fonts1, DT_NOCLIP, D3DCOLOR_ARGB(255, 1, 1, 1));
	ifont->DrawTextA(0, String, (int)strlen(String), &Fonts, DT_NOCLIP, D3DCOLOR_ARGB(255, 1, 1, 1));
	ifont->DrawTextA(0, String, (int)strlen(String), &Font, DT_NOCLIP, D3DCOLOR_ARGB(255, r, g, b));
	return 0;
}
